...
export const manifest = setupManifest({
  ...
  version: '0.1.4:5',
  releaseNotes: {
    en_US: 'Add Delete Obsolete Datasets action; bypass KuzuDB to remove old source-based datasets from SQLite directly.',
  },
  canMigrateTo: '=0.1.4:5',
  canMigrateFrom: '<=0.1.4:5',
  satisfies: [],
  gitHash: null,
