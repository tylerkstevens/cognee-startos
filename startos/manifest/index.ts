...
export const manifest = setupManifest({
  ...
  version: '0.1.3:0',
  releaseNotes: {
    en_US: 'Create tar staging directory before archiving and mount volume read-write during backup. Fixes tar "No such file or directory" failure.',
  },
  canMigrateTo: '=0.1.3:0',
  canMigrateFrom: '<=0.1.3:0',
  satisfies: [],
  gitHash: null,
